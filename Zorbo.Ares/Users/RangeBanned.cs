...
{
    public class RangeBanned : ReadOnlyList<Regex>, IRangeBanned
    {
        public RangeBanned() : base() {
        ...
        public bool Load(string directory) {
            ...
            Wrapped.Clear();
            String path = Path.Combine(directory, "RangeBans.xml");
        ...
        public bool Save(string directory) {
            ...
            try {
                ...
                var document = new XElement("RangeBans",
                               from x in this
